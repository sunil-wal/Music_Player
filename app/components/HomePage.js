...
import { TabContent, TabPane, Nav, NavItem, NavLink, Card, Button, CardTitle, CardText, Row, Col, ListGroup, ListGroupItem } from 'reactstrap';
...
class HomePage extends React.Component {
    ...
    render() {
        ...
        return (
          <div>
          <p>
            <Button color="primary" onClick={this.logoutFun}>Logout</Button>
                </p>
        <Nav tabs>
        <NavItem>
            <NavLink
